...
//* main class
//*******************************************************************//
public class Raycaster extends Applet implements Runnable {
	/**
	 * 
	 */
	...
	public void createTables() {
		...
		// CERATE A SIMPLE MAP
		byte[] map = { W, W, W, W, W, W, W, W, W, W, W, W, W, O, O, O, O, O, O, O, O, O, O, W, W, O, O, O, O, O, O, O, O, O, O, W, W, O, O, O, O, O,
				O, O, W, O, O, W, W, O, O, W, O, W, O, O, W, O, O, W, W, O, O, W, O, W, W, O, W, O, O, W, W, O, O, W, O, O, W, O, W, O, O, W, W, O,
				O, O, W, O, W, O, W, O, O, W, W, O, O, O, W, O, W, O, W, O, O, W, W, O, O, O, W, W, W, O, W, O, O, W, W, O, O, O, O, O, O, O, O, O,
	...
	public void run() {
		...
		fOffscreenImage = createImage(getWidth(), getHeight());
	...
	public void drawOverheadMap() {
		...
		for (int u = 0; u < MAP_WIDTH; u++) {
			for (int v = 0; v < MAP_HEIGHT; v++) {
				...
				fOffscreenGraphics.fillRect(PROJECTIONPLANEWIDTH + (u * fMinimapWidth), (v * fMinimapWidth), fMinimapWidth, fMinimapWidth);
			}
		}
	...
	public void drawRayOnOverheadMap(float x, float y) {
		...
		// intersect with wall
		fOffscreenGraphics.drawLine(fPlayerMapX, fPlayerMapY, (int) (PROJECTIONPLANEWIDTH + ((float) (x * fMinimapWidth) / (float) TILE_SIZE)),
		...
		fOffscreenGraphics.drawLine(fPlayerMapX, fPlayerMapY, (int) (fPlayerMapX + fCosTable[fPlayerArc] * 10),
...
//			float scaleFactor;
			...
			// fOffscreenGraphics.drawLine(castColumn, topOfWall, castColumn,
			// bottomOfWall);
